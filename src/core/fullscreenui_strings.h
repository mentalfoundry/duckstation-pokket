...
TRANSLATE_NOOP("FullscreenUI", "<not computed>");
...
TRANSLATE_NOOP("FullscreenUI", "BIOS '{}' installed as '{}'.");
TRANSLATE_NOOP("FullscreenUI", "BIOS Already Installed");
TRANSLATE_NOOP("FullscreenUI", "BIOS Directory");
TRANSLATE_NOOP("FullscreenUI", "BIOS Image");
TRANSLATE_NOOP("FullscreenUI", "BIOS Install Error");
TRANSLATE_NOOP("FullscreenUI", "BIOS Installed");
...
TRANSLATE_NOOP("FullscreenUI", "Clear Web Cache");
TRANSLATE_NOOP("FullscreenUI", "Clears a shader from the chain.");
TRANSLATE_NOOP("FullscreenUI", "Clears all cached images in the web cache.");
...
TRANSLATE_NOOP("FullscreenUI", "Copies a BIOS image to the configured global BIOS directory.");
...
TRANSLATE_NOOP("FullscreenUI", "Database updated.");
...
TRANSLATE_NOOP("FullscreenUI", "Device ID");
TRANSLATE_NOOP("FullscreenUI", "Device ID:");
...
TRANSLATE_NOOP("FullscreenUI", "Enter the device ID, as 8 hex digits.");
...
TRANSLATE_NOOP("FullscreenUI", "Global");
...
TRANSLATE_NOOP("FullscreenUI", "Hash Calculation Failed");
...
TRANSLATE_NOOP("FullscreenUI", "Install BIOS");
...
TRANSLATE_NOOP("FullscreenUI", "N/A");
...
TRANSLATE_NOOP("FullscreenUI", "Open on RetroAchievements");
...
TRANSLATE_NOOP("FullscreenUI", "Pin to OSD");
...
TRANSLATE_NOOP("FullscreenUI", "PocketStation");
TRANSLATE_NOOP("FullscreenUI", "PocketStation BIOS");
...
TRANSLATE_NOOP("FullscreenUI", "Puts a PocketStation in this slot instead of an ordinary memory card. Needs the PocketStation BIOS image to be set.");
...
TRANSLATE_NOOP("FullscreenUI", "Refresh Achievement Database");
TRANSLATE_NOOP("FullscreenUI", "Refresh Achievement Progress");
TRANSLATE_NOOP("FullscreenUI", "Refreshes the list of unlocked achievements.");
...
TRANSLATE_NOOP("FullscreenUI", "Search");
TRANSLATE_NOOP("FullscreenUI", "Search Directories");
TRANSLATE_NOOP("FullscreenUI", "Search on redump.info");
TRANSLATE_NOOP("FullscreenUI", "Seek Speedup");
TRANSLATE_NOOP("FullscreenUI", "Select");
TRANSLATE_NOOP("FullscreenUI", "Select BIOS Image");
...
TRANSLATE_NOOP("FullscreenUI", "Select PocketStation BIOS");
...
TRANSLATE_NOOP("FullscreenUI", "Selects between Xbox/PlayStation button icons in the footer and input binding.");
...
TRANSLATE_NOOP("FullscreenUI", "Serial (*)");
TRANSLATE_NOOP("FullscreenUI", "Serial of the device, as 8 hex digits. An app can read this and derive save content from it, so each slot has its own.");
TRANSLATE_NOOP("FullscreenUI", "Serial:");
...
TRANSLATE_NOOP("FullscreenUI", "The BIOS file '{}' is already installed. Do you want to overwrite it?");
TRANSLATE_NOOP("FullscreenUI", "The BIOS image of the PocketStation. The device answers each memory card command from this image, so a slot cannot hold one without it.");
...
TRANSLATE_NOOP("FullscreenUI", "Track");
TRANSLATE_NOOP("FullscreenUI", "Track hash copied to clipboard.");
...
TRANSLATE_NOOP("FullscreenUI", "Unpin from OSD");
TRANSLATE_NOOP("FullscreenUI", "Unset");
TRANSLATE_NOOP("FullscreenUI", "Update Database");
TRANSLATE_NOOP("FullscreenUI", "Update Progress");
TRANSLATE_NOOP("FullscreenUI", "Updates the database for achievements shown in the game list.");
...
TRANSLATE_NOOP("FullscreenUI", "Use PocketStation");
...
TRANSLATE_NOOP("FullscreenUI", "Verify");
TRANSLATE_NOOP("FullscreenUI", "Verifying Image");
...
TRANSLATE_NOOP("FullscreenUI", "Web Cache Size: {0} MB ({1} MB in {2} objects)");
TRANSLATE_NOOP("FullscreenUI", "Web cache cleared.");
...
TRANSLATE_NOOP("FullscreenUI", "{0} is not a PocketStation BIOS. That image is {1} bytes.");
...
TRANSLATE_NOOP("FullscreenUI", "{} | Start: {} | Length: {}");
